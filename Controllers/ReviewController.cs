...
namespace mvcmusicstore
{
    public class ReviewController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Review.Include(r => r.Album);
        ...
        public async Task<IActionResult> Create([Bind("ReviewID,AlbumID,Contents,ReviewerEmail")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewID,AlbumID,Contents,ReviewerEmail")] Review review)
        {
